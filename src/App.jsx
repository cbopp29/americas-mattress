        ...
        {tab==="bouncie"&&(
          <div className="fade">
            ...
            <div style={{...C.card,padding:"14px 16px",marginBottom:14,borderColor:"#1e3a5f"}}>
              ...
              <input value={bouncieSecret} onChange={e=>{const v=e.target.value;setBouncieSecret(v);try{localStorage.setItem("bouncie_secret",v);}catch(_){}}} placeholder="Client Secret" type="password" style={{...C.inp,width:"100%",marginBottom:8,fontFamily:"monospace"}}/>
